    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-3 mb-5 mb-lg-0">
                <!-- <h1 class="mb-4 section-title">Bienvenido/a Comisión</h1>-->
            <h1 class="mb-4 section-title">Bienvenido: <br>
            <?php
                ...
                <?php
                // Incluye el archivo de usuario desde la carpeta "php-login"
                // Luego, puedes acceder a la variable $user
                if (isset($user) && is_array($user)) {
                    echo "Alumno: " . $user['nombre'] . " " . $user['apellido'] ;
                } else {
                    header('Location: /php-login/index.php');
                    exit;
                }
                ...
                ?>
            <hr>
    <!-- Código a ejecutar si $user no está definida o no es un arreglo -->
            ...
            <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                <a class="product-item" href="https://classroom.google.com/">
            ...
            <!-- COLUMNA -->
            <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                <a class="product-item" href="https://meet.google.com/aqe-cbhh-ogf?authuser=0">
            ...
            <!-- /COLUMNA -->
            <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                <a class="product-item" href="https://classroom.google.com/a/not-turned-in/all">
